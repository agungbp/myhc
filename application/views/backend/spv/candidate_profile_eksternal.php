                        ...
                        <div class="card-body box-profile">
                            ...
                            <div class="dropdown" style="margin-bottom: 3px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="<?php echo site_url('spv/application/hire_approve/'. $row['candidate_ktp']); ?>">Approve</a>
                                    <a class="dropdown-item" href="<?php echo site_url('spv/application/hire_decline/'. $row['candidate_ktp']); ?>">Decline</a>
                                </div>
                            </div>
                            <a href="<?php echo site_url('spv/candidate/print_eksternal/'. $row['candidate_ktp']); ?>" target="_blank" class="btn btn-success btn-block"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print CV</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
