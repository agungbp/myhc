                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="#" onclick="FormModalMd('<?php echo site_url('modal/popup/employee_edit/'.$row['nik'] ); ?>');" class="btn btn-primary btn-block" style="margin-bottom: -5px;"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;<b>Update Shift</b></a>
