                ...
                <table id="tabel-data" class="table table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $row['marquee_date']; ?>
                            </td>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    ...
                                    <a href="#" class="btn btn-danger" onclick="DeleteModal('<?php echo site_url('superuser/marquee/delete/'. $row['marquee_id']); ?>');">
