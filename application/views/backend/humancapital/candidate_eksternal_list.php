            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo site_url('humancapital/vacancy/list'); ?>" class="btn btn-danger pull-left"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;Vacancy List</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="tabel-data" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <div class="btn-group">
                                            <a href="<?php echo site_url('humancapital/candidate/profile_eksternal/'. $row['candidate_ktp']); ?>" class="btn btn-info">
