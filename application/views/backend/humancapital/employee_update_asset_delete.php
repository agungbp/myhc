...
<div class="content-wrapper">
    ...
    <?php 
        ...
        $this->db->join('asset', 'asset_tmp.asset_id = asset.asset_id');
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <?php if($row['update_status'] == 'Waiting for Approval') { ?>
                                <a href="<?php echo site_url('humancapital/asset/update_asset_delete_approve/'. $row['update_id'].'/'.$row['asset_id']); ?>" class="btn btn-success btn-block"><i class="fas fa-check"></i>&nbsp;&nbsp;<b>Approve</b></a>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <strong>REQUEST DELETE DATA ASSET</strong>
                        </div>
                        <div class="card-body">
                        <div class="row">
