...
<div class="content-wrapper">
    ...
    <?php 
        ...
        foreach ($tmp->result_array() as $row):
            echo form_open(site_url('humancapital/asset/update_asset_create_approve/') . $row['update_id'] .'/'.$row['nik'], array('enctype' => 'multipart/form-data'));
    ?>
    <!-- Main content -->
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control" name="regional_code" value="<?php echo $row['regional_code']; ?>" readonly>
                            <input type="hidden" class="form-control" name="branch_code" value="<?php echo $row['branch_code']; ?>" readonly>
                            <input type="hidden" class="form-control" name="origin_code" value="<?php echo $row['origin_code']; ?>" readonly>
                            <input type="hidden" class="form-control" name="zone_code" value="<?php echo $row['zone_code']; ?>" readonly>
                            <input type="hidden" class="form-control" name="createby" value="<?php echo $row['createby']; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
