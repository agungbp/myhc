<?php 
    ...
    foreach ($family as $row):
        echo form_open(site_url('humancapital/family/update/'.$param2.'/'.$param3), array('enctype' => 'multipart/form-data')); ?>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>KTP</label>
                    <input type="number" class="form-control" name="family_ktp" value="<?php echo $row['family_ktp']; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label>BPJS</label>
                    <input type="number" class="form-control" name="family_bpjs" value="<?php echo $row['family_bpjs']; ?>">
                </div>
            </div>
            <div class="form-row">
