    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <a href="#" class="btn btn-primary pull-left" data-toggle="modal" data-target="#modal-md"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Department</a>
            </div>
            <div class="card-body">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    <a href="#" class="btn btn-success" onclick="FormModalMd('<?php echo site_url('modal/popup/section_edit/'.$row['section_code'] ); ?>');">
                                        <ion-icon name="create"></ion-icon>
                                    </a>
                                    <a href="#" class="btn btn-danger" onclick="DeleteModal('<?php echo site_url('humancapital/section/delete/'. $row['section_code']); ?>');">
