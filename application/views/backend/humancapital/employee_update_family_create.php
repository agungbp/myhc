...
<div class="content-wrapper">
    ...
    <?php 
        ...
        foreach ($tmp->result_array() as $row):
            echo form_open(site_url('humancapital/family/update_family_create_approve/') . $row['update_id'] .'/'.$row['nik'], array('enctype' => 'multipart/form-data'));
    ?>
    <!-- Main content -->
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <strong>REQUEST CREATE DATA FAMILY</strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
