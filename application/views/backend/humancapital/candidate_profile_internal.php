<?php 
    ...
    $this->db->join('vacancy', 'application.vacancy_id = vacancy.vacancy_id');
    $this->db->where('application.nik', $nik);
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Applied Position</b> <a class="float-right"><?php echo $row['vacancy_position'] . ' ' . $row['vacancy_level']; ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Applied Department</b> <a class="float-right"><?php echo $this->db->get_where('section', array('section_code' => $application->row()->vacancy_section))->row()->section_name; ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Applied Unit</b> <a class="float-right"><?php echo $this->db->get_where('unit', array('unit_code' => $application->row()->vacancy_unit))->row()->unit_name; ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Application Date</b> 
                                    <a class="float-right">
                                        <?php 
                                            $date = date_create($row['application_date']);
                                ...
                                <li class="list-group-item">
                                    ...
                                    <a class="float-right"><?php echo $row['application_status']; ?></a>
                                </li>
                            ...
                            <?php if ($row['application_status'] != 'Applied' || $row['application_status'] != 'SPV Declined') { ?>
                                <div class="dropdown" style="margin-bottom: 3px;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo site_url('humancapital/application/change_status_onreview_internal/'. $row['nik']); ?>">On Review</a>
                                        <a class="dropdown-item" href="<?php echo site_url('humancapital/application/change_status_psikotest_internal/'. $row['nik']); ?>">Psikotest</a>
                                        <a class="dropdown-item" href="<?php echo site_url('humancapital/application/change_status_interview_internal/'. $row['nik']); ?>">Interview</a>
                                        <a class="dropdown-item" href="<?php echo site_url('humancapital/application/change_status_hired_internal/'. $row['nik']); ?>">Hired</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="<?php echo site_url('humancapital/application/change_status_declined_internal/'. $row['nik']); ?>">Declined</a>
                                    </div>
                                </div>
                                <?php if ($row['application_status'] == 'Hired') { ?>
                                    <a href="<?php echo site_url('humancapital/candidate/move_internal/'. $row['nik']); ?>" class="btn btn-dark btn-block"><i class="fas fa-arrow-circle-right"></i>&nbsp;&nbsp;<b>Move Data</b></a>
                                <?php } ?>
                            <?php } ?>
                            <a href="<?php echo site_url('humancapital/employee/print/'. $row['nik']); ?>" target="_blank" class="btn btn-success btn-block"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print CV</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                                            ...
                                            <tbody>
                                                <?php foreach ($teguran->result_array() as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="btn-group">
                                                                <a href="<?php echo site_url('humancapital/teguran/print/'.$row['teguran_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            </div>
                                                        </td>
                                            ...
                                            <tbody>
                                                <?php foreach ($panggilan->result_array() as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="btn-group">
                                                                <a href="<?php echo site_url('humancapital/panggilan/print/'.$row['panggilan_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            </div>
                                                        </td>
