...
<div class="content-wrapper">
    ...
    <?php 
        ...
        $this->db->select('family.family_id, family.family_ktp, family.family_bpjs, family.family_name, family.family_status, employee.*, employee_update.*');
        $this->db->from('family');
        ...
        foreach ($tmp->result_array() as $row2):
            foreach ($family->result_array() as $row):
                echo form_open(site_url('humancapital/family/update_family_edit_approve/') . $row['update_id'] .'/'.$row['family_id'], array('enctype' => 'multipart/form-data'));
    ?>
    <!-- Main content -->
                            ...
                            <div class="row">
                                ...
                                <?php if($row['family_ktp'] != $row2['family_ktp']){ ?>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control border border-danger" value="<?php echo $row['family_ktp']; ?>" readonly>
                                    </div>
                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control border border-danger" name="family_ktp" value="<?php echo $row2['family_ktp']; ?>" readonly>
                                    </div>
                                <?php } else { ?>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control" value="<?php echo $row['family_ktp']; ?>" readonly>
                                    </div>
                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control" name="family_ktp" value="<?php echo $row2['family_ktp']; ?>"readonly>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
                                ...
                                <?php if($row['family_bpjs'] != $row2['family_bpjs']){ ?>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control border border-danger" value="<?php echo $row['family_bpjs']; ?>" readonly>
                                    </div>
                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control border border-danger" name="family_bpjs" value="<?php echo $row2['family_bpjs']; ?>" readonly>
                                    </div>
                                <?php } else { ?>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control" value="<?php echo $row['family_bpjs']; ?>" readonly>
                                    </div>
                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                    <div class="col-lg-3 col-4 col-form-label">
                                        <input type="number" class="form-control" name="family_bpjs" value="<?php echo $row2['family_bpjs']; ?>"readonly>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
