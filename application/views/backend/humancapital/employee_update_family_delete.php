...
<div class="content-wrapper">
    ...
    <?php 
        ...
        $this->db->join('family', 'family_tmp.family_id = family.family_id');
        $this->db->join('employee_update', 'employee_update.update_id = family_tmp.update_id');
        $this->db->join('employee', 'family_tmp.nik = employee.nik');
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <?php if($row['update_status'] == 'Waiting for Approval') { ?>
                                <a href="<?php echo site_url('humancapital/family/update_family_delete_approve/'. $row['update_id'].'/'.$row['family_id']); ?>" class="btn btn-success btn-block"><i class="fas fa-check"></i>&nbsp;&nbsp;<b>Approve</b></a>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <strong>REQUEST DELETE DATA FAMILY</strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <label class="col-lg-2 col-3 col-form-label">KTP</label>
                                <div class="col-lg-3 col-9 col-form-label">
                                    <input type="number" class="form-control" name="family_ktp" value="<?php echo $row['family_ktp']; ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-2 col-3 col-form-label">BPJS</label>
                                <div class="col-lg-3 col-9 col-form-label">
                                    <input type="number" class="form-control" name="family_bpjs" value="<?php echo $row['family_bpjs']; ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-2 col-3 col-form-label">Status</label>
                                <div class="col-lg-3 col-9 col-form-label">
                                    <input type="text" class="form-control" name="family_status" value="<?php echo $row['family_status']; ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-2 col-3 col-form-label">Name</label>
                                <div class="col-lg-3 col-9 col-form-label">
                                    <input type="text" class="form-control" name="family_name" value="<?php echo $row['family_name']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
