    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open(site_url('humancapital/plafon/filter')); ?>
        ...
        <div class="card">
            ...
            ?>
                    <div class="card-header">
                        <a href="#" class="btn btn-primary pull-left" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Plafon</a>
                        <a href="#" class="btn btn-dark" data-toggle="modal" data-target="#modal-md"><i class="fas fa-file-import"></i>&nbsp;&nbsp;&nbsp;Import Data</a>
                    </div>
            <?php } ?>
            <div class="card-body">
                ...
                <table id="tabel-data" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                            $this->db->select('plafon.*, employee.employee_name, employee.section_code');
                            $this->db->from('employee');
                            $this->db->join('plafon', 'plafon.nik = employee.nik');
                            $this->db->where('employee_status !=', 'Resign');
                            $this->db->where('plafon_periode', 0);
                        ...
                        ?>
                                <tr>
                                    ...
                                    ?>
                                            <td style="text-align: center;">
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-success" onclick="FormModal('<?php echo site_url('modal/popup/plafon_edit/'.$row['plafon_id'] ); ?>');">
                                                        <ion-icon name="create"></ion-icon>
                                                    </a>
                                                    <a href="#" class="btn btn-danger" onclick="DeleteModal('<?php echo site_url('humancapital/plafon/delete/'. $row['plafon_id']); ?>');">
