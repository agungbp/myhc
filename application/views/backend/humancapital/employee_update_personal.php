...
<div class="content-wrapper">
    ...
    <?php 
        ...
        $this->db->join('employee_tmp', 'employee.nik = employee_tmp.nik');
        $this->db->join('employee_update', 'employee_tmp.update_id = employee_update.update_id');
        ...
        foreach ($tmp->result_array() as $row2):
            foreach ($employee->result_array() as $row):
                echo form_open(site_url('humancapital/employee/update_approve/') . $row['update_id'] .'/'.$row['nik'], array('enctype' => 'multipart/form-data'));
    ?>
                    <!-- Main content -->
                                ...
                                <div class="col-md-9">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <label class="col-lg-2 col-3 col-form-label">Join Date</label>
                                                <?php if($row['employee_join'] != $row2['employee_join']){ ?>
                                                    <div class="col-lg-3 col-4 col-form-label">
                                                        <input type="text" class="form-control border border-danger" value="<?php echo $row['employee_join']; ?>" readonly>
                                                    </div>
                                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                                    <div class="col-lg-3 col-4 col-form-label">
                                                        <input type="text" class="form-control border border-danger" name="employee_join" value="<?php echo $row2['employee_join']; ?>" readonly>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="col-lg-3 col-4 col-form-label">
                                                        <input type="text" class="form-control" value="<?php echo $row['employee_join']; ?>" readonly>
                                                    </div>
                                                    <label class="col-lg-1 col-1 col-form-label text-center"><i class="fas fa-arrow-right"></i></label>
                                                    <div class="col-lg-3 col-4 col-form-label">
                                                        <input type="text" class="form-control" name="employee_join" value="<?php echo $row2['employee_join']; ?>"readonly>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                            <div class="row">
