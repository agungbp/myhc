                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="<?php echo site_url('humancapital/employee/edit/'. $row['nik']); ?>" class="btn btn-primary btn-block" style="margin-bottom: -5px;"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;<b>Update Profile</b></a>
                            <a href="<?php echo site_url('humancapital/employee/print/'. $row['nik']); ?>" target="_blank" class="btn btn-success btn-block" style="margin-bottom: -5px;"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print CV</b></a>
                            <!-- <a href="#" class="btn btn-dark btn-block" onclick="FormModalMd('<?php echo site_url('modal/popup/employee_qrcode/'.$row['nik'] ); ?>');"><i class="fas fa-qrcode"></i>&nbsp;&nbsp;<b>Generate QR Code</b></a> -->
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
