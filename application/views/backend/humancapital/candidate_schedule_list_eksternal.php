...
<div class="row">
    <div class="col-sm-12">
        <a href="<?php echo site_url('humancapital/recruitment_schedule/print_eksternal/'. $param2); ?>" target="_blank" class="btn btn-success" style="margin-bottom: 5px;"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print Attendance List</b></a>
            ...
            <table id="tabel-data" class="table table-striped table-bordered table-hover">
                ...
                <?php foreach ($candidate->result_array() as $row): ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="#" class="btn btn-danger" onclick="DeleteModal('<?php echo site_url('humancapital/recruitment_schedule/delete_candidate/'. $row['candidate_ktp']); ?>');">
