        ...
        <div class="row">
            <div class="col-sm-12 text-justify">
                <div class="row">
                    ...
                    <div class="col-11 text-justify" style="margin-bottom: 15px;">
                        <b>Sdr. <?php echo $row['employee_name']; ?></b>, Pemegang No. KTP: <?php echo $row['employee_ktp']; ?>, bertempat tinggal di <?php echo $row['employee_address']; ?>, Jenis kelamin <?php echo $row['employee_gender']; ?>, Tempat tnggal lahir <?php echo $row['employee_birthplace'] . ', ' . date_indo($row['employee_birthdate']); ?>, Pendidikan <?php echo $row['employee_education']; ?> dan dalam hal ini bertindak untuk diri sendiri, selanjutnya disebut sebagai <b>Pihak Kedua</b>.
                    </div>
