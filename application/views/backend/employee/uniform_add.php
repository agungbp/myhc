<?php echo form_open(site_url('employee/uniform/create'), array('enctype' => 'multipart/form-data')); ?>
    <div class="form-row">
        <div class="form-group col-md-12">
            <label class="required">Type</label>
            <select class="form-control selectpicker" name="uniformrequest_type" data-live-search="true" required>
