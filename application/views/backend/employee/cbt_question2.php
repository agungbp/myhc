...
<html lang="en">
    ...
    <body class="hold-transition layout-top-nav">
        <div class="wrapper">
                                        ...
                                        ?>
                                                <div class="tab-pane">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="<?php echo site_url('employee/exam/answer2/'. $row['exam_id'] . '/' . $number . '/' . $row['question_id'] . '/A'); ?>">
                                                        ...
                                                        <a href="<?php echo site_url('employee/exam/answer2/'. $row['exam_id'] . '/' . $number . '/' . $row['question_id'] . '/B'); ?>">
                                                        ...
                                                        <a href="<?php echo site_url('employee/exam/answer2/'. $row['exam_id'] . '/' . $number . '/' . $row['question_id'] . '/C'); ?>">
                                                        ...
                                                        <a href="<?php echo site_url('employee/exam/answer2/'. $row['exam_id'] . '/' . $number . '/' . $row['question_id'] . '/D' ); ?>">
                                                        ...
                                                        <a href="<?php echo site_url('employee/exam/answer2/'. $row['exam_id'] . '/' . $number . '/' . $row['question_id'] . '/E'); ?>">
                                                        ...
                                                        <?php } else { 
                                                                echo form_open(site_url('employee/exam/answeressay/' . $row['exam_id'] . '/' . $number . '/' . $row['question_id']), array('enctype' => 'multipart/form-data')); ?>
                                                                <div class="row">
            ...
            <?php echo form_open(site_url('employee/exam/finish/'.$model['exam_id']), array('enctype' => 'multipart/form-data')); ?>
                <!-- /.content-wrapper -->
