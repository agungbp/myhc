                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="<?php echo site_url('employee/profile/edit/'. $row['nik']); ?>" class="btn btn-primary btn-block" style="margin-bottom: -5px;"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;<b>Request Update Profile</b></a>
                            <!-- <a href="#" class="btn btn-dark btn-block" onclick="FormModalMd('<?php echo site_url('modal/popup/employee_qrcode/'.$row['nik'] ); ?>');" style="margin-bottom: -5px;"><i class="fas fa-qrcode"></i>&nbsp;&nbsp;<b>Generate QR Code</b></a> -->
                            <a href="<?php echo site_url('employee/profile/print/'. $row['nik']); ?>" target="_blank" class="btn btn-success btn-block"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print CV</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="spk">
                                    <?php 
                                        ...
                                        $spk = $this->db->get_where('spk', array('nik' => $this->session->userdata('login_nik')));
                                        if($spk->num_rows() < 1){ 
                                            ?>
                                            <div class="alert alert-info">
                                                No data to display
                                                            ...
                                                            <td style="text-align: center;">
                                                                <div class="btn-group">
                                                                    <?php if ($row['spk_status'] == 'FREELANCE') { ?>
                                                                        <a href="<?php echo site_url('employee/spk/print_freelance/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } else if ($row['spk_status'] == 'MITRA') { ?>
                                                                        <a href="<?php echo site_url('employee/spk/print_mitra/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } else if ($row['spk_status'] == 'PKWT1' || $row['spk_status'] == 'PKWT2') { ?>
                                                                        <a href="<?php echo site_url('employee/spk/print_pkwt/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } ?>
                                                                </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($teguran->result_array() as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="btn-group">
                                                                <a href="<?php echo site_url('employee/teguran/print/'.$row['teguran_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            </div>
                                                        </td>
                            ...
                            <div class="tab-pane" id="file">
                                <?php 
                                    $file = $this->db->get_where('file', array('nik' => $this->session->userdata('login_nik')));
                                    if($file->num_rows() < 1){ 
                                ?>
                                        <div class="alert alert-info">
                                            No data to display
