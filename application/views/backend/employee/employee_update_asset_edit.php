...
<div class="content-wrapper">
    ...
    <?php 
        ...
        $this->db->select('asset.asset_number, asset.asset_serialnumber, asset.asset_name, asset.asset_merk, asset.asset_model, asset.asset_date, asset.asset_spesification, employee.*');
        $this->db->from('asset');
