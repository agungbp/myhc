            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <?php echo $this->db->get_where('employee', array('section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                        <?php echo $this->db->get_where('employee', array('employee_status' => 'Tetap', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php echo $this->db->get_where('employee', array('employee_status' => 'PKWT1', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php echo $this->db->get_where('employee', array('employee_status' => 'PKWT2', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                        <?php echo $this->db->get_where('employee', array('employee_status' => 'SOS', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php echo $this->db->get_where('employee', array('employee_status' => 'Freelance', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php echo $this->db->get_where('employee', array('employee_status' => 'Mitra', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <?php echo $this->db->get_where('employee', array('employee_status' => 'HS 2020', 'section_code' => $this->session->userdata('login_section'), 'branch_code' => $this->session->userdata('login_branch')))->num_rows(); ?>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                ...
                <div class="card">
                    <?php echo form_open(site_url('admin/employee/filter')); ?>
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-7 col-12" style="text-align: right; margin-top: 5px;">Join Period</div>
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align: center;"><?php echo $row['nik']; ?></td>
                                            ...
                                            <td style="text-align: center;" width="5%">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('admin/employee/profile/'. $row['nik']); ?>" class="btn btn-info">
