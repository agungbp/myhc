                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="<?php echo site_url('admin/employee/print/'. $row['nik']); ?>" target="_blank" class="btn btn-success btn-block"><i class="fas fa-print"></i>&nbsp;&nbsp;<b>Print CV</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                                                            ...
                                                            <td style="text-align: center;">
                                                                <div class="btn-group">
                                                                    <?php if ($row['spk_status'] == 'FREELANCE') { ?>
                                                                        <a href="<?php echo site_url('admin/spk/print_freelance/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } else if ($row['spk_status'] == 'MITRA') { ?>
                                                                        <a href="<?php echo site_url('admin/spk/print_mitra/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } else if ($row['spk_status'] == 'PKWT1' || $row['spk_status'] == 'PKWT2') { ?>
                                                                        <a href="<?php echo site_url('admin/spk/print_pkwt/'.$row['spk_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                            <ion-icon name="print"></ion-icon>
                                                                        </a>
                                                                    <?php } ?>
                                                                </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($teguran->result_array() as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="btn-group">
                                                                <a href="<?php echo site_url('admin/teguran/print/'.$row['teguran_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            </div>
                                                        </td>
                                            ...
                                            <tbody>
                                                <?php foreach ($panggilan->result_array() as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="btn-group">
                                                                <a href="<?php echo site_url('admin/panggilan/print/'.$row['panggilan_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            </div>
                                                        </td>
