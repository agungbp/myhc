    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open(site_url('head/melahirkan/filter')); ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <?php } elseif($row['melahirkan_status'] == 'Declined') { ?>
                                    <h5><span class="badge badge-danger"><?php echo $row['melahirkan_status'] ?></span></h5>
                                <?php } elseif ($row['melahirkan_status'] == 'Approved') { ?>
                                    <h5><span class="badge badge-success"><?php echo $row['melahirkan_status'] ?></span></h5>
