                    ...
                    ?>
                                        <tr style="text-align: center;">
                                            ...
                                            ?>
                                                    <td style="text-align: center;">
                                                        <div class="btn-group">
                                                            <a href="<?php echo site_url('head/employee/edit/'. $row2['nik']); ?>" class="btn btn-info">
                                                                <ion-icon name="person"></ion-icon>
                                                            </a>
                                                            <?php if ($row2['spk_status'] == 'FREELANCE') { ?>
                                                                <a href="<?php echo site_url('head/spk/print_freelance/'.$row2['spk_id'].'/'.$row2['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            <?php } else if ($row2['spk_status'] == 'MITRA') { ?>
                                                                <a href="<?php echo site_url('head/spk/print_mitra/'.$row2['spk_id'].'/'.$row2['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            <?php } else if ($row2['spk_status'] == 'PKWT1' || $row2['spk_status'] == 'PKWT2') { ?>
                                                                <a href="<?php echo site_url('head/spk/print_pkwt/'.$row2['spk_id'].'/'.$row2['nik']); ?>" class="btn btn-dark" target="_blank">
                                                                    <ion-icon name="print"></ion-icon>
                                                                </a>
                                                            <?php } ?>
                                                        </div>
