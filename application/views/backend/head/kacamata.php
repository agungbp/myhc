    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open(site_url('head/kacamata/filter')); ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <?php } elseif($row['kacamata_status'] == 'Declined') { ?>
                                    <h5><span class="badge badge-danger"><?php echo $row['kacamata_status'] ?></span></h5>
                                <?php } elseif ($row['kacamata_status'] == 'Approved') { ?>
                                    <h5><span class="badge badge-success"><?php echo $row['kacamata_status'] ?></span></h5>
