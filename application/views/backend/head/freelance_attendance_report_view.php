...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php echo form_open(site_url('head/freelance_attendance_report_selector')); ?>
            <!-- Default box -->
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="section_code" class="form-control selectpicker" data-live-search="true" required>
                                    ...
                                    foreach ($sections as $row2): ?>
                                        <option value="<?php echo $row2['section_code']; ?>"
                                            <?php if($row2['section_code'] == $section_code) echo 'selected'; ?>>
                                                <?php echo $row2['section_name']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                                ...
                                <table id="tabel-data" class="table table-striped table-bordered table-hover" style="max-width: none; font-size: 10px;">
                                    ...
                                    <tbody>
                                        ...
                                        if($section_code == 'All') {
                                            ...
                                            $this->db->where('fpayroll_date', DateTime::createFromFormat('Y-m-d', $year . '-' . $month . '-28')->format('Y-m-d'));
                                            $sql = $this->db->get();
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; padding: 5px;">
                                                    <?php
                                                        ...
                                                        $data['fpayroll_date']       = $year . '-' . $month . '-28';
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="#" class="btn btn-dark" onclick="FormModal('<?php echo site_url('modal/popup/freelance_payslip_details/' . $row['fpayroll_id'] ); ?>');">
