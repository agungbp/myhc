                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    <a class="btn btn-success" href="#" onclick="FormModalMd('<?php echo site_url('modal/popup/panggilan_result/'.$row['panggilan_id'] ); ?>');"><ion-icon name="create"></ion-icon></a>
                                    <a href="<?php echo site_url('head/panggilan/print/'.$row['panggilan_id'].'/'.$row['nik']); ?>" class="btn btn-dark" target="_blank">
                                        <ion-icon name="print"></ion-icon>
                                    </a>
                                    <a href="<?php echo site_url('head/employee/edit/'. $row['nik']); ?>" class="btn btn-info">
