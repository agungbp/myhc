...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php $question = $this->db->get_where('survey_question', array('survey_id' => $survey_id))->result_array(); ?>
                ...
                <table id="tabel-data" class="table table-striped table-bordered table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <?php $responds = $this->db->get_where('survey_responds', array('survey_id' => $survey_id, 'responden_id' => $row['responden_id']))->result_array(); ?>
                            <?php foreach ($responds as $row2): ?>
